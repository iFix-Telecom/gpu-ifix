...
export const FIELD_GROUPS: FieldGroup[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        field: "created_budget_s",
        label: "Orçamento estado created (s)",
        kind: "int",
        configKey: "created_budget_s",
        minKey: "created_budget_s_min",
        maxKey: "created_budget_s_max",
        nextProvision: true,
      },
      {
        field: "progress_stall_budget_s",
        label: "Orçamento stall de download (s)",
        kind: "int",
        configKey: "progress_stall_budget_s",
        minKey: "progress_stall_budget_s_min",
        maxKey: "progress_stall_budget_s_max",
        nextProvision: true,
      },
      {
