  ...
  it("hits /api/gateway/primary/config and parses PodConfigResponse", async () => {
    ...
    const payload: PodConfigResponse = {
      config: {
        ...
        created_budget_s: 120,
        progress_stall_budget_s: 120,
      ...
      bounds: {
        ...
        created_budget_s_min: 30,
        created_budget_s_max: 600,
        progress_stall_budget_s_min: 30,
        progress_stall_budget_s_max: 600,
