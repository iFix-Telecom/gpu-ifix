...
- [ ] 11.1-01-PLAN.md — Wave 1: reconciler/lifecycle drop role=stt + Vast DefaultSearchFilters primary+fallback + config field rename + gatewayctl upstreamNameRole cleanup
