...
status: passed
score: 8/8 must-haves verified (automated); SC-1 PASS (live UAT 2026-05-25) + SC-2 IMPLIED + SC-3 PASS (re-verified 2026-05-23); SC-4 + SC-5 deferred
overrides_applied: 0
re_verification:
  ...
  gaps_closed_2026_05_25:
    - "SC-1 full overflow → tier-1 — vegeta 5 RPS × 30s burst (150 requests) on 2026-05-25 against ai-gateway-dev (image develop-560aa2a) with local-llm FORCED_OPEN: 99.33% success (149/150 HTTP 200; 1 vegeta-client-side timeout, no gateway/upstream errors), all 200s served by openrouter-chat → DeepSeek v4 Flash via OpenRouter. Was 86.67% on 2026-05-13 (tier-1 returned 502 because OpenRouter URL not configured + model rewrite not wired). Phase 06.9 (PR #1-#5) closed the entire blocking chain. See 06.9-HUMAN-UAT.md S6 + 06.9-VERIFICATION.md."
  gaps_closed_phase_10_2026_05_26:
    - "SC-1 re-verified under PROD URL 2026-05-26 (image sha256:17e9873ec810) — vegeta 5 RPS × 30s burst (150 requests) against https://ai-gateway.converse-ai.app/v1/chat/completions with local-llm FORCED_OPEN: 100.00% success (150/150 HTTP 200, zero errors), all served via openrouter-chat tier-1; p50 4.13s, p95 5.93s, max 16.93s. Confirms Phase 06.9 fix + Phase 10 prod stack deploy hold end-to-end. SC-4 (anti-starvation under shed) and SC-5 (DCGM scrape evidence) remain deferred per scope (primary pod absent this UAT — no shed signal to exercise + no GPU to scrape). See 10-HUMAN-UAT.md S8."
  gaps_remaining:
